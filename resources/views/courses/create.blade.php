...
@section('content')
    ...
    <!-- /.row -->
    <form method="post" action="{{ route('courses.store') }}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="Enter text" name="details">

                                </div>

                                <div class="form-group">
                                    <label>Class/Level for course</label>
                                <select id="level_id" class="form-control" name="level_id" onchange="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="e.g. One Month" name="duration" id="duration">
                                </div>
